<?php
    /**
     * @Filename: class-nh-bootstrap-Navwalker.php
     * @Description:
     ...
     */
    class Nh_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
         ...
         */
        private function seporate_linkmods_and_icons_from_classes(array $classes, array &$linkmod_classes, array &$icon_classes, int $depth): array
        {
