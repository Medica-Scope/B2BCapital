<?php
    /**
     * @Filename: class-Nh_Post.php
     * @Description: This file contains the Nh_Post class, which represents a NH post. It provides methods for retrieving, converting, inserting, updating, and deleting posts.
    ...
    /**
     * The Nh_Post class represents a NH post.
     *
     * @class Nh_Post
     * @package NinjaHub
     */
    class Nh_Post
    {
        ...
        /**
         * @var \NH\APP\CLASSES\Nh_Post|null The singleton instance of the Nh_Post class.
         */
        private static ?Nh_Post $instance = NULL;
        ...
        /**
         * Constructs a new Nh_Post object.
         */
        ...
        /**
         * Returns the Nh_Post instance for the given WP_Post object and metadata.
         *
         * @param WP_Post $post The WP_Post object.
         * @param array   $meta_data The metadata of the post.
         *
         * @return \NH\APP\CLASSES\Nh_Post The Nh_Post instance.
         */
        public static function get_post(WP_Post $post, array $meta_data = []): Nh_Post
        {
            $class          = __CLASS__;
        ...
        /**
         * Converts a WP_Post object to a Nh_Post object.
         *
         * @param WP_Post $post The WP_Post object.
         * @param array   $meta_data The metadata of the post.
         *
         * @return \NH\APP\CLASSES\Nh_Post The converted Nh_Post object.
         */
         ...
         */
        public function insert(): int|WP_Error|Nh_Post
        {
...
//                $this->ID = $insert;
         ...
         *
         * @return Nh_Post|WP_Error The updated Nh_Post instance or WP_Error object on failure.
         */
        public function update(): Nh_Post|WP_Error
        {
