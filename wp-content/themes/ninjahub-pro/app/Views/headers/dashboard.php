                ...
                <div class="bbc-logged-in-actions">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item bbc-user-profile-btn dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="dropdown" data-bs-auto-close="true">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('my-account'))) ?>">
                                        <?= __('My Profile', 'ninja') ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('my-account/my-opportunities'))) ?>">
                                        <?= __('My Opportunities', 'ninja') ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('dashboard/create-opportunity'))) ?>">
                                        <?= __('Create Opportunities', 'ninja') ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('my-account/my-widgets'))) ?>">
                                        <?= __('My Widgets', 'ninja') ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('my-account/my-favorite-articles'))) ?>">
