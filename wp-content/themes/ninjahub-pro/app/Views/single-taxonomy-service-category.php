                                            ...
                                            <div class="services-group">
                                                <?php
                                                    foreach ($column as $index => $service) {
                                                        ?>
                                                        <div class="service">
                                                            <span class="service-number"><?= str_pad($number + 1, 2, '0', STR_PAD_LEFT); ?>.</span>
                                                            <h3 class="service-title"><?= $service->title ?></h3>
                                                            <p class="service-description"><?= $service->meta_data['short_description'] ?></p>
                                                            <a href="<?= $service->link ?>" class="service-link">
                                                                <?= __('Read more', 'ninja') ?>
                                                                <span class="service-link-icons"><i class="icon bbc-right"></i><i class="icon bbc-right"></i></span>
                                                            </a>
                                                        </div>
                                                        <?php
                                                        $number++;
