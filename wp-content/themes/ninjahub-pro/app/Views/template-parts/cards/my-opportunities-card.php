...
$opportunity_modified          = ! empty( $args['opportunity_modified'] ) ? $args['opportunity_modified'] : false;
$opportunity_created_date      = ! empty( $args['opportunity_created_date'] ) ? $args['opportunity_created_date'] : false;
$opportunity_short_description = ! empty( $args['opportunity_short_description'] ) ? $args['opportunity_short_description'] : false;
$opportunity_stage             = ! empty( $args['opportunity_stage'] ) ? $args['opportunity_stage'] : false;
