				...
				if ( ! empty( $opportunities ) ) {
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="my-opportunity-tab" data-bs-toggle="pill"
								data-bs-target="#my-opportunity" type="button" role="tab" aria-controls="my-opportunity"
								aria-selected="true">
								<?= __( "My Opportunities", "ninja" ) ?>
							</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="fav-opportunity-tab" data-bs-toggle="pill"
								data-bs-target="#fav-opportunity" type="button" role="tab" aria-controls="fav-opportunity"
								aria-selected="false">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="my-opportunity" role="tabpanel"
							aria-labelledby="my-opportunity-tab" tabindex="0">
							<?php
							foreach ( $opportunities as $opportunity ) {
								...
								<div class="opportunity-card">
									...
									<span class="date">
										<?php echo get_the_date( 'F jS, Y', $opportunity->ID ) ?>
									</span>
									...
									<?php if ( ! empty( $user_ID ) ) : ?>
										<div class="ninja-fav-con">
											<button class="ninja-add-to-fav btn <?= ( $fav_chk ) ? 'btn-dark' : '' ?>" id="addToFav"
						...
						<div class="tab-pane fade" id="fav-opportunity" role="tabpanel" aria-labelledby="fav-opportunity-tab"
							tabindex="0">
							<?php
								...
								foreach ( $favorite_opportunities as $fav_opportunity_id ) {
									...
									if ( $favorite_opportunity ) {
										...
										<div class="opportunity-card">
											...
											<?php } ?>
											<h3>
												<?= $favorite_opportunity->name ?>
											</h3>
											<span class="date">
												<?php echo get_the_date( 'F jS, Y', $favorite_opportunity->ID ) ?>
											</span>
											<p class="short-description">
												<?= $favorite_opportunity->meta_data['short_description'] ?>
											</p>
											<span class="status">
												<?= $favorite_opportunity->status ?>
											</span>
										</div>
										<?php
									}
