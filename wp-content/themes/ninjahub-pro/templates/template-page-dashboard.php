                    ...
                    <div class="dashboard-opportunity-list-container">
                        <div class="opportunity-list-header row justify-content-between align-items-center">
                            ...
                            <div class="opportunity-actions col-6">
                                ...
                                <button class="btn btn-outline-warning opportunity-adv-filter" data-bs-toggle="button"><i class="bbc-sliders"></i> Advanced Filters
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-container">
                        ...
                        <?php if (Nh_User::get_user_role() !== Nh_User::INVESTOR) { ?>
                            <div class="sidebar-create-opportunity shadow">
                                <a href="<?= apply_filters('nhml_permalink', get_permalink(get_page_by_path('dashboard/create-opportunity'))); ?>" class="btn-create-opportunity btn btn-success btn-lg shadow text-uppercase">
