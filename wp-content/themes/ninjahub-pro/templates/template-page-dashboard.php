                            ...
                            <div class="opportunity-list-header row justify-content-between align-items-center">
                                ...
                                <div class="opportunity-actions col-6">
                                    <div class="opportunity-list-sort">
                                        <button
                                            class="btn btn-light bg-transparent opportunity-list-style grid-switch <?= (isset($_COOKIE['grid_view']) && $_COOKIE['grid_view'] == 'list-group') ? 'active' : '' ?>"
                                            data-view="list-group">
                                            <i class="bbc-th-list"></i>
                                        </button>
                                        <button
                                            class="btn btn-light bg-transparent opportunity-list-filter grid-switch <?= (isset($_COOKIE['grid_view']) && $_COOKIE['grid_view'] == 'card-group') ? 'active' : '' ?>"
                                    ...
                                    <div class="filters">
                                        ...
                                        <button class="btn btn-outline-warning opportunity-adv-filter" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFilter"
                            ...
                            <?php if (Nh_User::get_user_role() !== Nh_User::INVESTOR) { ?>
                                <div class="sidebar-create-opportunity shadow">
                                    ...
                                    <small class="pt-3">
                                        ...
                                        <span class="text-warning"><?= __('One Opportunity In Month', 'ninja') ?></span>
                                    </small>
                                </div>
                            <?php } ?>
