            ...
            <section class="login-section container-xl col-12 col-md-6 py-5 px-5 px-xl-6">
                ...
                <div class="section-header">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h1 class="section-title"><?= __('Sign Up', 'ninja') ?></h1>
                        <p><?= sprintf(__('I have account! <a href="%s" class="btn-link text-accent">Login</a>', 'ninja'), apply_filters('nhml_permalink', get_permalink(get_page_by_path('my-account/login')))) ?> </p>
                    </div>
                    ...
                    <div class="or-separator">
                        ...
                        <span class="separator-text"><?= __('OR', 'ninja') ?></span>
