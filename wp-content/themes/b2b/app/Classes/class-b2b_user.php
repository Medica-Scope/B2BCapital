<?php
    ...
    class B2b_User
    {
        ...
        public static function get_currentuser_profile(): ?B2b_User
        {
        ...
        {
            if (empty($this->user_meta['email_confirmation_status']) || !boolval($this->user_meta['email_confirmation_status'])) {
                return FALSE;
            }
