<?php
    ...
    class B2b_Mail
    {
        ...
        public static function init(): B2b_Mail
        {
            return new self;
        }
         ...
         * @return $this
         */
        public function to($to): B2b_Mail
        {
            if (is_array($to)) {
                $this->to = $to;
            } else {
         ...
         *
         * @return B2b_Mail $this
         */
        public function cc($cc): B2b_Mail
        {
            if (is_array($cc)) {
                $this->cc = $cc;
            } else {
         ...
         * @return B2b_Mail $this
         */
        public function bcc($bcc): B2b_Mail
        {
            if (is_array($bcc)) {
                $this->bcc = $bcc;
            } else {
         ...
         * @return B2b_Mail $this
         */
        public function from($from): B2b_Mail
        {
            $this->from = $from;
            return $this;
        }
         ...
         * @return B2b_Mail $this
         */
        public function headers($headers): B2b_Mail
        {
            if (is_array($headers)) {
         ...
         * @return B2b_Mail $this
         */
        public function sendAsHTML(bool $html): B2b_Mail
        {
         ...
         * @throws \Exception
         */
        public function attach($path): B2b_Mail
        {
            if (is_array($path)) {
                $this->attachments = [];
         ...
         * @throws \Exception
         */
        public function templateHeader(string $template, array $variables = NULL): B2b_Mail
        {
         ...
         * @throws \Exception
         */
        public function template(string $template, array $variables = NULL): B2b_Mail
        {
            $template = $this->templateStart . $template . '.php';
         ...
         * @throws \Exception
         */
        public function templateFooter(string $template, array $variables = NULL): B2b_Mail
        {
            $template = $this->templateStart . $template . '.php';
