        ...
        <?php
            $form_fields = [
                ...
                'opportunity_type'   => [
                    ...
                    'options'        => [
                            'regular' => __('Regular', 'b2b'),
                            'bidding' => __('Bidding', 'b2b'),
                            'acquisition' => __('Acquisition', 'b2b'),
                    ],
                    'default_option' => '',
                    'select_option'  => [],
                    'before'      => '',
                ...
                'project_phase'   => [
                    ...
                    'options'        => [
                        'preparation' => __('Preparation', 'b2b'),
                        'created' => __('Created', 'b2b'),
                        'started' => __('Started', 'b2b'),
                        'running' => __('Running', 'b2b'),
                        'paused' => __('Paused', 'b2b'),
                    ],
                    'default_option' => '',
                    'select_option'  => [],
                    'before'      => '',
