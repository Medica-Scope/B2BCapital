                                                    ...
                                                    ->create_form([
                                                        'fields_appearance'   => [
                                                            ...
                                                            'choices'     => [
                                                                ...
                                                                [
                                                                    'label'      => 'stake to be sold percentage',
                                                                    'required'   => '',
                                                                    'class'      => '',
                                                                    'id'         => '',
                                                                    'name'       => Nh::_DOMAIN_NAME . '_stake_to_be_sold_percentage',
                                                                    'value'      => 1,
                                                                    'before'     => '',
                                                                    'after'      => '',
                                                                    'checked'    => (int)NH_CONFIGURATION['opportunities_fields'][Nh::_DOMAIN_NAME . '_stake_to_be_sold_percentage'] === 1 ? 'checked' : '',
                                                                    'order'      => 0,
                                                                    'extra_attr' => []
                                                                ],
                                                                [
